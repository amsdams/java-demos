        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="product-order-product" name="productId" data-cy="product" label="Product" type="select" required>
                <option value="" key="0" />
                {products
              ...
              <ValidatedField id="product-order-cart" name="cartId" data-cy="cart" label="Cart" type="select" required>
                <option value="" key="0" />
                {shoppingCarts
